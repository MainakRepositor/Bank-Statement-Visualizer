...
st.write('Export your Bank statement (Made on HDFC Bank) as a XLS file and drop it here to analyze your expenses')
st.info("Note: We don't store your data. It's all done locally on your machine")

st.image('https://blogassets.leverageedu.com/blog/wp-content/uploads/2019/06/23160336/Career-in-Banking.png')

with st.sidebar:

    sample_statements = ["statement23.xls",
                        "statement22.xls"]
    ...
    balance_trend = st.checkbox("Display Balance Trend")
    transaction = st.checkbox("Display Transaction Info")
    upi_trans = st.checkbox("Display UPI Transaction Info")
    show_summary = st.checkbox("Show Banking Summary")
